...
[![Speed](https://img.shields.io/badge/Speed-200%2B%20MB%2Fs%20(Gigabit%20LAN)-00F0FF?style=for-the-badge&logo=speedtest&logoColor=black)](https://github.com/)
[![License](https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge)](LICENSE)
[![Size](https://img.shields.io/badge/Windows%20App-238%20KB-orange?style=for-the-badge)](https://github.com/)
[![Size](https://img.shields.io/badge/Android%20APK-1.59%20MB-brightgreen?style=for-the-badge)](https://github.com/)
...
- 🚀 **Ultimate Transfer Speed**: Direct TCP streaming with `TcpNoDelay = true` and 2MB socket buffers delivering **200+ MB/s** (~1.6 Gbps) line speed without cloud relay bottlenecks.
- 📡 **Zero-Configuration Instant Discovery**: Automatic peer discovery using UDP broadcast (`255.255.255.255:53317`) and multicast beacons. No Bluetooth pairing or IP typing required.
...
- 📦 **Minimal Binary Footprint**:
  - **Windows App**: **~238 KB** (.NET 10 WPF native glassmorphic UI).
  - **Windows Setup Installer**: **~430 KB** (1-click installer and uninstaller).
  - **Android Release APK**: **1.59 MB** (Kotlin + Jetpack Compose Material 3).
...
- 🎨 **Modern Dark Aesthetic**: Sleek obsidian & cyan glassmorphism UI, real-time live speedometers in **MB/s** and **Gbps**, animated radar scanner, and category badges (`VIDEO`, `IMAGE`, `AUDIO`, `ARCHIVE`, `DOC`, `CODE`).
...
+-----------------------------------------------------------------------------+
    ...
    Windows PC <==== Periodic Beacons / Multicast ====> Android Device
...
A local loopback socket benchmark transferring a 25 MB payload:
...
### 📱 Android
1. Download `SpeedShare-v1.0.0.apk` from the [Latest Release](https://github.com/).
2. Tap to install, or install via ADB:
   ```bash
   adb install -r SpeedShare-v1.0.0.apk
   ```
